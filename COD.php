...
<h3 class="text-center"> <strong>If you missed to review our side please click on to the button</strong> <span style="color: black;"></span> </h3>
<h1 class="text-center">
<a class="btn btn-success btn-lg" href="rating1.php" role="button" > Rating </a>
<a class="btn btn-success btn-lg" href="review.php" role="button" > Review </a>
</h1>
        </body>
