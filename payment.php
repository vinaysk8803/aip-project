...
<h1 class="text-center">
  ...
  <a href="rating1.php"><button class="btn btn-success"><span class="glyphicon glyphicon-circle-arrow-left"></span> Rating</button>
  <a href="review.php"><button class="btn btn-success"><span class="glyphicon glyphicon-circle-arrow-left"></span> Review</button>
</h1>
